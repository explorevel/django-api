...
class IndonesiaBanks(models.Model):
...
class reports(models.Model):
    ...
    total_companies = models.SmallIntegerField(blank=True, null=True)
    total_market_cap = models.IntegerField(blank=True, null=True)
